...
Pada soal nomor 2 ini, kita diminta untuk mengunakan FUSE dan mount folder yang berisi pesan dan rahasia-berkas. di folder pesan itu kita diminta untuk mengdekode file txt dengan prefix yang ada, di folder rahasia-berkas itu kita diminta membuat password di foldernya sendiri dan semua file yang didalamnya. Terakhir kita juga membuat file log untuk mencatat semua yang terjadi.

ini kode untuk bagian ngelognya:
...
ini kode untuk mengdekodekan file.txtnya:
...
ini kode untuk membuat passwordnya dan untuk mengambil info dari folder dan semua file yang didalamnya ke mount:
...
ini kode untuk mengidentifikasi prefix:
...
### Kesalahan yang dialami dan revisi:

- fungsi kode yang mengdekode belum bisa

- fungsi passwordnya belum bisa
